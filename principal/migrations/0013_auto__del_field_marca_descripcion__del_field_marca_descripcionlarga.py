...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Marca.descripcion'
        raise RuntimeError("Cannot reverse this migration. 'Marca.descripcion' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Marca.descripcion'
        db.add_column(u'principal_marca', 'descripcion',
                      self.gf('django.db.models.fields.CharField')(max_length=120),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Marca.descripcionlarga'
        raise RuntimeError("Cannot reverse this migration. 'Marca.descripcionlarga' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Marca.descripcionlarga'
