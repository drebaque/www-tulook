...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'principal_categoria', (
            ...
            ('idcategoria', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.create_table(u'principal_producto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('idproducto', self.gf('django.db.models.fields.IntegerField')()),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('destacado', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('precio', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Categoria'])),
        ))
        db.send_create_signal(u'principal', ['Producto'])

        # Adding model 'DatosEmpresa'
        db.create_table(u'principal_datosempresa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('razonsocial', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('nfantasia', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('cuit', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ...
            ('horarios', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('linkgooglemaps', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'principal', ['DatosEmpresa'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'principal_producto')

        # Deleting model 'DatosEmpresa'
        db.delete_table(u'principal_datosempresa')
    ...
    models = {
        ...
        u'principal.producto': {
            ...
            'descripcion': ('django.db.models.fields.TextField', [], {}),
            'destacado': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
