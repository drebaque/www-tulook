...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marca.telefono_contacto'
        db.add_column(u'principal_marca', 'telefono_contacto',
                      self.gf('django.db.models.fields.CharField')(default='0261-xxxxxxxxx', max_length=15),
                      keep_default=False)

        # Adding field 'DatosEmpresa.telefono'
        db.add_column(u'principal_datosempresa', 'telefono',
                      self.gf('django.db.models.fields.CharField')(default='0261-xxxxxxxxx', max_length=15),
                      keep_default=False)

        # Adding field 'DatosEmpresa.celular'
        db.add_column(u'principal_datosempresa', 'celular',
                      self.gf('django.db.models.fields.CharField')(default='0261-xxxxxxxxx', max_length=15),
                      keep_default=False)


        # Changing field 'DatosEmpresa.email'
        db.alter_column(u'principal_datosempresa', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50))

        # Changing field 'Promo.fechafinalizacion'
        db.alter_column(u'principal_promo', 'fechafinalizacion', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Promo.fechainicio'
        db.alter_column(u'principal_promo', 'fechainicio', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Marca.telefono_contacto'
        db.delete_column(u'principal_marca', 'telefono_contacto')

        # Deleting field 'DatosEmpresa.telefono'
        db.delete_column(u'principal_datosempresa', 'telefono')

        # Deleting field 'DatosEmpresa.celular'
        db.delete_column(u'principal_datosempresa', 'celular')


        # Changing field 'DatosEmpresa.email'
        db.alter_column(u'principal_datosempresa', 'email', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Promo.fechafinalizacion'
        db.alter_column(u'principal_promo', 'fechafinalizacion', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Promo.fechainicio'
        db.alter_column(u'principal_promo', 'fechainicio', self.gf('django.db.models.fields.DateTimeField')())
