...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'principal_marca', 'descripcionlarga',
                      self.gf('django.db.models.fields.TextField')(default=131215),
                      keep_default=False)


        # Changing field 'Marca.descripcion'
        db.alter_column(u'principal_marca', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Marca.descripcion'
        db.alter_column(u'principal_marca', 'descripcion', self.gf('django.db.models.fields.TextField')())
