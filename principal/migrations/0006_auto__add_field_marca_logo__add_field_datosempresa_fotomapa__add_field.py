...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marca.logo'
        db.add_column(u'principal_marca', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(default=-13, max_length=100),
                      keep_default=False)

        # Adding field 'DatosEmpresa.fotomapa'
        db.add_column(u'principal_datosempresa', 'fotomapa',
                      self.gf('django.db.models.fields.files.ImageField')(default=-12, max_length=100),
                      keep_default=False)

        # Adding field 'Producto.foto'
        db.add_column(u'principal_producto', 'foto',
                      self.gf('django.db.models.fields.files.ImageField')(default=-11, max_length=100),
                      keep_default=False)

        # Adding field 'Promo.foto'
        db.add_column(u'principal_promo', 'foto',
                      self.gf('django.db.models.fields.files.ImageField')(default=-12, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Marca.logo'
        db.delete_column(u'principal_marca', 'logo')

        # Deleting field 'DatosEmpresa.fotomapa'
        db.delete_column(u'principal_datosempresa', 'fotomapa')

        # Deleting field 'Producto.foto'
        db.delete_column(u'principal_producto', 'foto')

        # Deleting field 'Promo.foto'
        db.delete_column(u'principal_promo', 'foto')
